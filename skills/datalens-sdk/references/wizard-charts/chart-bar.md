...
| `axis_scale()` | `slot_name: Literal['x'], *, scale: Literal['linear', 'logarithmic'] = 'linear', mode: Literal['auto', 'manual'] = 'auto', min: str \| None = None, max: str \| None = None` | CU |
| `grid()` | `slot_name: Literal['x', 'y'], *, enabled: bool, step: int \| None = None` | CU |
| `hide_labels()` | `slot_name: Literal['x', 'y'], *, enabled: bool` | CU |
| `nulls_mode()` | `slot_name: Literal['x'], *, mode: Literal['ignore', 'connect', 'as-0', 'use-previous']` | CU |
