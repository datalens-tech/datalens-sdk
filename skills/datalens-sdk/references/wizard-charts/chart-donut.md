...
Factory: `client.create.wizard_chart.donut(name=..., location=...)`
`chart.visualization_id`: `donut`
...
| --- | --- | --- |
| `client.create.wizard_chart.donut()` | `name: str`, `location: EntryLocation` | C |
...
chart = (
    client.create.wizard_chart.donut(
        name="Donut",
...
- `x` sets the dimension field; `y` sets the required measure field.
- Both dimensions and measures have capacity 1.
