...
**What NOT to do:** do not parse the raw body yourself and continue, and do not change the SDK version to "match the server" — package installation and upgrades belong to the root `datalens-skills` bootstrap.
