...
**What NOT to do:** do not parse the raw body yourself and continue, and do not upgrade or unpin the SDK to "match the server" — the skill works against `datalens-sdk==0.4.0`.
