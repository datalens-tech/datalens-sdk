...
class DashTabItemV2OneOf5DataDTO(BaseModel):
    ...
    title: str = _UNVALIDATED_NONE_DEFAULT
    widget_tab_ids: Annotated[list[Annotated[str, Field(min_length=1)]], Field(min_length=1, max_length=5, alias='widgetTabIds')]
...
class DashDataV2DTO(BaseModel):
    ...
    tabs: Annotated[list[DashTabV2DTO], Field(min_length=1)]
